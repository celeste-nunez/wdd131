 export const recipes = [
	{
		...
		recipeImg: './images/sweet-potato-waffle-md.jpg',
		recipeIngredient: [
			'2 separated eggs',
			'1/4 C Oil',
			'1/4 tsp salt',
		...
		recipeName: 'Sweet Potato Waffles',
		prepTime: '30 Min',
		recipeInstructions: [
	...
	},
	{
		...
		recipeImg: './images/escalopes-de-poulet-a-la-creme.webp',
		recipeIngredient: [
		...
		recipeName: 'Escalope de Poulet a la Creme with steamed green beans (Chicken with Cream)',
		prepTime: '10 min',
		recipeInstructions: [
	...
	},
	{
		...
		recipeImg: './images/roasted-potatoes.webp',
		recipeIngredient: [
			'3-4 Medium Potatoes',
			'1 Tbsp Olive oil',
		...
		recipeName: 'Oven Roasted potato slices',
		prepTime: '10 min',
		recipeInstructions: [
	...
	},
	{
		...
		recipeImg: './images/black-beans-and-rice.jpg',
		recipeIngredient: [
		...
		recipeName: 'Black Beans and Rice',
		prepTime: '10 min',
		recipeInstructions: [
	...
	},
	{
		...
		recipeImg: './images/chicken-curry.webp',
		recipeIngredient: [
			'4 Slices Bacon',
			'1 clove Garlic',
			'2 Tbsp Flour',
	...
	},
	{
		...
		recipeImg: './images/chocolate-chip-cookies.jpg',
		recipeIngredient: [
	...
	},
	{
		...
		recipeImg: './images/german-gooseberry-cake.jpg',
		recipeIngredient: [
			'For the Cake Base:',
		...
		recipeName: 'Gooseberry cake with vanilla cream and crumble',
		prepTime: '30 min',
		recipeInstructions: [
	...
	},
	{
		...
		recipeImg: './images/apple-crisp.jpg',
		recipeIngredient: [
